...
progressUpdate(steps: 30, goal: goal)
progressUpdate(steps: 3330, goal: goal)
progressUpdate(steps: 6850, goal: goal)
progressUpdate(steps: 9000, goal: goal)
progressUpdate(steps: 101010, goal: goal)
progressUpdate(steps: 10000, goal: goal)
progressUpdate(steps: 0, goal: goal)
/*:
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime:Double, goalTime: Double){
    ...
    if totalDistance-currentDistance <= currentRate * (goalTime - currentTime) {
        print("Keep it up!")
    } else {
