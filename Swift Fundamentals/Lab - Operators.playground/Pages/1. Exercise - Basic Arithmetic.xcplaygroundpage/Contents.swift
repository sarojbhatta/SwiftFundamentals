...
let integerDivisionResult1 = double10/double3
print(integerDivisionResult1)
print("Here integerDivisionResult for double prints a double value. It is because in case I when integer was divided by integer, the resulting value was an integer, whereas in case II, a double divides another double. The use of at least one double in the operations should give a double value.")
/*:
...
print(even%2)
print(odd%2)
print("The use of % operator determines that if a number % by 2 gives 0, it is an even number. If it gives 1, it is an odd number")
