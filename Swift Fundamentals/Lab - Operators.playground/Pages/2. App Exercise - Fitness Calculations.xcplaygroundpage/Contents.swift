...
print(averageHRD)
print("The answer is different from the previous one because in case I, it is purely an integer divison whereas in case II, it is a double division")
/*:
