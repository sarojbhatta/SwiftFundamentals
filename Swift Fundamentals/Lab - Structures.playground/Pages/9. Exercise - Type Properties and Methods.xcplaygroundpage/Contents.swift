...
struct User {
    ...
    static var currentUser = User(userName: "SB", email: "sb@sb.com", age: 20)
...
print("current user is: \(User.currentUser.userName)")
/*:
 ...
 */
User.logIn(user: User(userName: "newSB", email: "newSB@sb.com", age: 25))
print("current user is: \(User.currentUser.userName)")
