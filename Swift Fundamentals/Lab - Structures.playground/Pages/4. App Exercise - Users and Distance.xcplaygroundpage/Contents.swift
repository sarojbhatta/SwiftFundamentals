 ...
 */
var sb = User(name: "SB", age: 20, height: 170, weight: 135, activityLevel: 6)
print("\(sb.name) has an age of \(sb.age), height of \(sb.height) cms, mass of \(sb.weight) pounds and activity level of \(sb.activityLevel).")
...
struct Distance{
    ...
    init(distMeters:Double) {
        self.distMeters = distMeters
        distFeet = distMeters*3.28084
    }
    init(distFeet:Double) {
        self.distFeet = distFeet
        distMeters = distFeet/3.28084
    }
}
 ...
 */
var mile = Distance(distMeters: 1600)
print(mile.distFeet)

/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var mile2 = Distance(distMeters: 1)
print(mile2.distMeters)
print(mile2.distFeet)
