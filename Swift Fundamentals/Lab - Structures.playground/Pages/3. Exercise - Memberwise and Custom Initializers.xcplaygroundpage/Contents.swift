...
var favoriteBook = Book(title: "Book No1", author: "S B", pages: 256, price: 22.99)

print("The book, \(favoriteBook.title), which was writen by \(favoriteBook.author) in \(favoriteBook.pages) pages and costs \(favoriteBook.price), is my favorite.")
